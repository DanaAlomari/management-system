function emplo ( ID , fullname , department ,level ) {
...
let employee1 = new emplo( 1000 , " Ghazi samer ", "Administration", "Senior")
let employee2=new emplo(1001 , "Lana Ali" , "Finance" , "Senior" );
let employee3=new emplo(1002 , "Tamara Ayoub" , "Marketing" , "Senior" );
let employee4=new emplo(1003 , "Safi Walid" , "Administration" , "Mid-Senior" );
let employee5=new emplo(1004 , "Omar Zaid" , "Development" , "Senior" );
let employee6=new emplo(1005 , "Rana Saleh" , "Development" , "Junior" );
let employee7=new emplo(1006 , "Hadi Ahmad" , "Finance" , "Mid-Senior" );
